...
class MangaResource extends JsonResource
{
    public function toArray($request): array
    {
        return [
            ...
            'categories' => new FilterCollection($this->whenLoaded('categories')),
            'genres' => new FilterCollection($this->whenLoaded('genres')),
            'tags' => new FilterCollection($this->whenLoaded('tags')),
